...
#define HAVE_PSM2_LIB_REFCOUNT_CAP 1
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-DNDEBUG -g -O2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -ffile-prefix-map=/build/openmpi=. -flto=auto -ffat-lto-objects -fstack-protector-strong -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection -fdebug-prefix-map=/build/openmpi=/usr/src/openmpi-4.1.6-7ubuntu2 -O3 -finline-functions -fno-strict-aliasing -mcx16  -D__EXTENSIONS__' CPPFLAGS='-Wdate-time -D_FORTIFY_SOURCE=3    -I/usr/local/include -I/usr/local/include' FFLAGS='-g -O2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -ffile-prefix-map=/build/openmpi=. -flto=auto -ffat-lto-objects -fstack-protector-strong -fstack-clash-protection -fcf-protection -fdebug-prefix-map=/build/openmpi=/usr/src/openmpi-4.1.6-7ubuntu2' LDFLAGS='-Wl,-Bsymbolic-functions -flto=auto -ffat-lto-objects -Wl,-z,relro   ' --enable-shared --disable-static  --prefix=/usr --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_TARBALL_VERSION "4.1.6"

/* Complete release number of Open MPI */
#define OMPI_VERSION "6"
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 13.2.0
...
#define OPAL_IDENT_STRING "4.1.6"
...
#define OPAL_OFI_PCI_DATA_AVAILABLE 1
...
#define OPAL_RELEASE_DATE "Sep 30, 2023"
...
#define OPAL_TARBALL_VERSION "4.1.6"

/* Complete release number of Open Portable Access Layer */
#define OPAL_VERSION "6"
...
#define ORTE_RELEASE_DATE "Sep 30, 2023"
...
#define OSHMEM_RELEASE_DATE "Sep 30, 2023"
...
#define OSHMEM_TARBALL_VERSION "4.1.6"

/* Complete release number of Open SHMEM */
#define OSHMEM_VERSION "6"
...
#define PACKAGE_STRING "Open MPI 4.1.6"
