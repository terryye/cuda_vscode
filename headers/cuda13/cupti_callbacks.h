 ...
 */
#define CUPTI_SUBSCRIBER_NAME_MAX_LEN 53

/**
 * The minimum size of the of the old subscriber name in bytes. 
 */
#define CUPTI_OLD_SUBSCRIBER_NAME_MIN_LEN 64
...
#define CUpti_SubscriberParams_STRUCT_SIZE                  CUPTI_CALLBACK_STRUCT_SIZE(CUpti_SubscriberParams, oldSubscriberSize)
 ...
 */
CUptiResult CUPTIAPI cuptiSubscribe_v2(CUpti_SubscriberHandle *subscriber,
                                       CUpti_CallbackFunc callback,
                                       void *userdata,
