...
extern "C" {
  ...
  cusolverStatus_t CUSOLVERAPI cusolverDnSetMathMode(
    cusolverDnHandle_t handle,
    cusolverMathMode_t mode);
  cusolverStatus_t CUSOLVERAPI cusolverDnGetMathMode(
    cusolverDnHandle_t handle,
    cusolverMathMode_t* mode);

  cusolverStatus_t CUSOLVERAPI cusolverDnSetEmulationStrategy(
    cusolverDnHandle_t handle,
    cudaEmulationStrategy_t strategy);

  cusolverStatus_t CUSOLVERAPI cusolverDnGetEmulationStrategy(
    cusolverDnHandle_t handle,
    cudaEmulationStrategy_t* strategy);
